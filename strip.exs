...
#
#   elixir strip.exs <score-file> [prefix] [--overwrite]
#
# Examples:
#   elixir strip.exs triebwerke.score
#   elixir strip.exs triebwerke.score grandma
#   elixir strip.exs triebwerke.score output --overwrite
#
...
case positional do
  [] ->
    IO.puts(:stderr, "usage: elixir strip.exs <score-file> [prefix] [--overwrite]")
    System.halt(1)
